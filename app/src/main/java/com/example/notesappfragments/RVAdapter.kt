...
import com.example.notesappfragments.databinding.NotesViewBinding

class RVAdapter (private val context: ShowNotes,private val list: ArrayList<Data>): RecyclerView.Adapter<RVAdapter.ItemViewHolder>() {
